...
.error{color:red} 
body{
background-image:url("resources/cliparts/update.jpg");
background-size:40%;
...
<body>
	...
	if (session.getAttribute("email") ==null || session.getAttribute("userType").equals("front")) {
     ...
     <div>
		...
		<form:form action="editUser" modelAttribute="editUserForm">
		<form:errors path="*" cssClass="error"/> 
        <table aria-label="User Edit" style="padding-left:20%;border-collapse:separate;border-spacing: 0 15px;">
           <tr>
           	   <th>Corporate Id:</th>
               <td><form:input type="text" value="${editUserForm.getCorporateId()}" path="corporateId" style="height:30px;width:250px;" title="You cannot change this field" readonly="true" /></td>
           </tr>
           <tr>
           		<th>Login Id:</th>
