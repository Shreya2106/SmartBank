...
#corporate{
background-image:url("resources/cliparts/corporate-icon-1.jpg");
background-size:cover;
background-repeat:no-repeat;
}
#user{
background-image:url("resources/cliparts/user-icon1.jpg");
background-size:cover;
background-repeat:no-repeat;
}
#account{
background-image:url("resources/cliparts/account-icon-1.jpg");
background-size: 100%;
}
th{
	font-weight:normal;
