...
<body>
    ...
    if (session.getAttribute("email") ==null || session.getAttribute("userType").equals("front")) {
       ...
       <% if(response.getStatus() == 200){ %>
		...
		<h2 style="font-family:serif;color:red;font-weight:bold;font-size:large;text-align:center;"> Sorry we could not add since * ${errorMsg} </h2>
		</div>
		...
		<div style="margin-top:5%;text-align:center;">
			...
			<a href="account.jsp">go back</a> or
