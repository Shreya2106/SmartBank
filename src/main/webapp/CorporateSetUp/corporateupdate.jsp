	...
	<sql:setDataSource var="dbsource" driver="com.mysql.cj.jdbc.Driver"
     ...
     <div>
		<div class="nav">
			...
			<a href="CorporateSetUp/corporate.jsp">Corporate Home SetUp</a>
        ...
        <input type="hidden" value="${param.id}" name="id" />
           ...
           <tr>
           		...
           		<td><input type="text" value="${row.corporateName}" name="corpName" style="height:30px;width:250px;" title="You cannot change this field" readonly/></td>
           	</tr>
           <tr>
           		<tr>
           		<td>Address:</td>
