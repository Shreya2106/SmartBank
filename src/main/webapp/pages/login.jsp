...
<style>
body{
background-image:url("cliparts/login.jpg");
background-size:50%;
   ...
   <div class="cards">
	...
	<form action="login" method="post">
		...
		<tr><th id="email">Email:</th></tr>
  		<tr><td><input type="email" name="username" id="username" placeholder="Enter email" title="Enter your email/loginId" style="height:30px;width:250px;" required></td>
 		</tr>
 		<tr><th id="pass">Password:</th></tr>
  		<tr><td><input type="password" name="password" id="password"  placeholder="Enter password" style="height:30px;width:250px;" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
