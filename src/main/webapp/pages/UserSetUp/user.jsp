			...
			<c:forEach var="row" items="${result}">
				<table aria-label="User Details" class="ac">
				   <tr class="ac-r">
                    ...
                    <tr>
                        <td><c:out value="${row.corporate.corporateId}"/></td>
			 	...
			 	<form:errors path="*" cssClass="error"/> 
   					<table aria-label="Add User" style="padding-left:5%;border-collapse:separate; width:100%;">
						<tr>
  							...
  							<td><form:select path="corporate.corporateId" style="width: 70%;" required="true">
  									<c:forEach var="row1" items="${result1}">
  									<form:option value="${row1}"><c:out value="${row1}"/></form:option>
  									</c:forEach>
  								</form:select>
  							</td>
 						</tr>
